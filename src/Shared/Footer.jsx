...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-sky-50 to-violet-50 p-8 text-black py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-5">
        ...
        <div>
          ...
          <ul className="space-y-2 font-sans font-normal text-sm">
            <li>
              <a href="#">Is Jobright Legit?</a>
            </li>
            <li>
              <a href="#">Success Stories from Jobright Users</a>
            </li>
            <li>
              <a href="#">What Top AI Companies Are Looking For</a>
            </li>
            <li>
              <a href="#">Jobright AI Agent Launch</a>
            </li>
            <li>
              <a href="#">Top Entry Level Jobs</a>
            </li>
          </ul>
        </div>
        ...
        <div>
          <div>
            ...
            <ul className="space-y-2 font-sans font-normal text-sm">
              <li>
                <a href="#">AI Job Assistant</a>
              </li>
              <li>
                <a href="#">AI Cover Letter Generator</a>
              </li>
              <li>
                <a href="#">AI Resume Helper</a>
              </li>
              <li>
                <a href="#">AI Job Tracker</a>
              </li>
            </ul>
          </div>
        </div>
