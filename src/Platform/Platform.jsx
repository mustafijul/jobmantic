      ...
      <div className="text-black flex mt-6">
        ...
        <div className="w-1/2 me-32 mb-32 p-8 mt-4 rounded-lg relative text-black">
          <div className="items-center mx-auto">
            <h1 className="text-gray-700 w-36 bg-white border-rounded p-2 justify-center ms-80">
              job description
            </h1>
          </div>
          <div className="flex">
            <h1 className="text-gray-700 w-36 h-10 bg-white border-rounded p-2 justify-center ms-12 mt-20">
              Resume
            </h1>
